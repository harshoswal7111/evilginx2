...
func showAd() {
	...
	message := fmt.Sprintf("%s: %s %s", lred.Sprint("WebSec Training Course"), lyellow.Sprint("https://academy.breakdev.org/websec-mastery"), white.Sprint("(learn how to create phishlets)"))
	log.Info("%s", message)
}
